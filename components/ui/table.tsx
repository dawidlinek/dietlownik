...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-[var(--color-bone)] transition-colors hover:bg-[var(--color-oat)] data-[state=selected]:bg-[var(--color-oat)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "text-left align-middle font-medium text-[var(--color-ink-3)]",
      className
    )}
    {...props}
  />
